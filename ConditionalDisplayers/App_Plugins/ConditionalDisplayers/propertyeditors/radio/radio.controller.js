...
angular.module("umbraco").controller("Our.Umbraco.ConditionalDisplayers.RadioController", function ($scope, validationMessageService, editorState, cdSharedLogic) {
    ...
    $scope.labelsPos = $scope.model.config.labelsPos !== undefined && $scope.model.config.alignHrz === '1' && $scope.model.config.asBtn !== '1' ? "cd-labels-" + $scope.model.config.labelsPos : 'right';
